...
main()
{
    ...
    while(gets(s))
    {
        for(int i=0; i<strlen(s); i++)
        {
            ...
            else if (s[i]=='-' || s[i]=='_') s[i]='9';
            else if (s[i]=='0' || s[i]==')') s[i]='8';
            else if (s[i]=='9' || s[i]=='(') s[i]='7';
            else if (s[i]=='8' || s[i]=='*') s[i]='6';
            else if (s[i]=='7' || s[i]=='&') s[i]='5';
            else if (s[i]=='6' || s[i]=='^') s[i]='4';
            else if (s[i]=='5' || s[i]=='%') s[i]='3';
            else if (s[i]=='4' || s[i]=='$') s[i]='2';
            else if (s[i]=='3' || s[i]=='#') s[i]='1';
            else if (s[i]=='2' || s[i]=='@') s[i]='`';
            else if(s[i]=='\'') s[i]='l';
